...
class GlobalExceptionHandler {
    ...
    suspend fun handle(exception: IllegalArgumentException): ResponseEntity<FailResponse> {
    ...
    suspend fun handle(exception: ConstraintViolationException): ResponseEntity<FailResponse> {
        logger.error { exception }
    ...
    suspend fun handle(exception: MethodArgumentNotValidException): ResponseEntity<FailResponse> {
        logger.error { exception }
    ...
    suspend fun handle(exception: NoSuchElementException): ResponseEntity<FailResponse> {
        logger.error { exception }
    ...
    suspend fun handle(exception: Exception): ResponseEntity<ErrorResponse> {
        logger.error { exception }
