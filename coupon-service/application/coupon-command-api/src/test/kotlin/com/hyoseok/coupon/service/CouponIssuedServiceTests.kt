...
internal class CouponIssuedServiceTests : DescribeSpec(
    {
        ...
        val mockCouponIssuedLogRepository: CouponIssuedLogRepository = mockk()
        ...
        val couponIssuedService = CouponIssuedService(
            ...
            couponIssuedLogRepository = mockCouponIssuedLogRepository,
        ...
        describe("create 메서드는") {
            ...
            it("회원에게 쿠폰을 발급한다") {
                ...
                coEvery { mockCouponIssuedLogRepository.save(couponIssuedLog = any()) } returns Unit
                ...
                coVerify { mockCouponIssuedLogRepository.save(couponIssuedLog = any()) }
